...
class QuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post quests_url, params: { quest: { answer_idx: @quest.answer_idx, options: @quest.options, question: @quest.question } }
    end
  ...
  test "should update quest" do
    patch quest_url(@quest), params: { quest: { answer_idx: @quest.answer_idx, options: @quest.options, question: @quest.question } }
